...
* 🎯 My goal is to  ***revolutionize art and science by combining technologies and creativity together***
* 💦 Progressing in `Hardware`, `System Programming`, `SRE`, `Audio/Video`
* 🌱 In my free time, I read `books`, study `screenwriting`, `directing` and `sound design`, play the `piano` and `guitar`.
* ⚡ How to reach me:
